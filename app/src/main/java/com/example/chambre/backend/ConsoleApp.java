...
public class ConsoleApp {
    ...
    private static void printMenu() {
        ...
        System.out.println("2. Add more available dates for your rooms.");
        System.out.println("3. See the reservations of your rooms.");
        System.out.println("4  See the rooms you own.");
        System.out.println("5. See the total reservations you have by area and date.");
